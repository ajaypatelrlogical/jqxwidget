$(document).ready(function() {
	...
	jqxGridHeight = main_content_height - 41;
	...
	var initGrid = function () {
	    ...
	    $("#loginHistoryGrid").jqxGrid($.extend(commonJQXGridOpt,
        {
	...
	var initGrid2 = function () {
	    ...
	    var initrowdetails = function (index, parentElement, gridElement, datarecord) {
            ...
            if (tabsdiv != null) {
            	information = tabsdiv.find('.row_detail_template_html');
                $(information).append("Inner Html Here");
            }
       	}

	    var dataAdapter = new $.jqx.dataAdapter(source);
	    $("#emailHistoryGrid").jqxGrid($.extend(commonJQXGridOpt,
        {
        	height: jqxGridHeight,
	        source: dataAdapter,
	        rowdetails: true,
            rowdetailstemplate: { rowdetails: "<div style='overflow-y: auto; height: 100%; 'class='row_detail_template_html'></div>", rowdetailsheight: 500 },
	...
	$('#tabs').jqxTabs({ initTabContent: initWidgets });

	jqxGridHeaderAction("#loginHistoryGrid");
	jqxGridHeaderAction("#emailHistoryGrid");
});